...
// console.log(books.filter(book => book.rating >= MIN_RATING));

// console.log(books.filter(book => book.author === AUTHOR ));
//=================TASK==============================================
// const users=[
//   {
//     name: "Moore Hensley",
...
// console.log(getUserWithEmail(users, "blackburndotson@fsgfdsgurnigeer.com"));